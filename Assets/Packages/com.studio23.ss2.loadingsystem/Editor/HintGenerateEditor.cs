...
namespace Studio23.SS2.SceneLoadingSystem.Editor
{
    public class HintGenerateEditor : EditorWindow
    {
        ...
        private LoadingScreenTextTable LoadingHintData;

        private string assetName = "HintsData";
        private string folderPath = "Assets/Resources/";
        private Vector2 scrollPosition = Vector2.zero;
        private Dictionary<TextType, List<string>> temporaryHintsDictionary = new Dictionary<TextType, List<string>>();
        ...
        {
            foreach (TextType hintType in Enum.GetValues(typeof(TextType)))
            {
        ...
        private List<string> GetTemporaryHintList(TextType hintType)
        {
        ...
        private void SaveHintsData()
        {
            ...
            LoadingScreenTextTable newHints = ScriptableObject.CreateInstance<LoadingScreenTextTable>();
            newHints.HintsInfo = new List<TextData>();

            foreach (var hintPair in temporaryHintsDictionary)
            {
                TextData hintData = new TextData
                {
                    Type = hintPair.Key,
        ...
        private void CreateOrLoadProgressData()
        {
            ...
            LoadingHintData = Resources.Load<LoadingScreenTextTable>("HintsData");
            ...
            if (LoadingHintData != null)
            {
                ...
                {
                    //temporaryHintsDictionary.Add(hintData.Type, new List<string>(hintData.Description));
                }
            }
        }
